...
import { PrismaStaffRepository } from '../../staff/infrastructure/persistence/prisma-staff.repository';
...
describe('PrismaStaffRepository', () => {
  ...
  beforeEach(async () => {
    ...
    repository = module.get<PrismaStaffRepository>(PrismaStaffRepository);
  ...
  it('deve revogar convite dentro do tenant', async () => {
    jest.spyOn(repository, 'findInvitationById').mockResolvedValue({ id: 'invite-1', status: 'revoked' } as any);
