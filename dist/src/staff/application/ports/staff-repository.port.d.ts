export interface StaffRepositoryPort {
    ...
    findByLicenseNumber(licenseNumber: string, tenantId: string, excludeId?: string): Promise<any | null>;
    ...
    findPendingInvitationByLicenseNumber(licenseNumber: string, tenantId: string): Promise<any | null>;
