...
exports.GetMissingPatientsUseCase = void 0;
const common_1 = require("@nestjs/common");
const dashboard_tokens_1 = require("../../dashboard.tokens");
let GetMissingPatientsUseCase = class GetMissingPatientsUseCase {
    constructor(repository) {
        this.repository = repository;
    }
    async execute(tenantId, daysInactive = 3) {
...
exports.GetMissingPatientsUseCase = GetMissingPatientsUseCase;
exports.GetMissingPatientsUseCase = GetMissingPatientsUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(dashboard_tokens_1.DASHBOARD_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetMissingPatientsUseCase);
//# sourceMappingURL=get-missing-patients.use-case.js.map