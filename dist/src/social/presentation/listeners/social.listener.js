...
let SocialListener = class SocialListener {
    constructor(createSocialPostUseCase) {
        this.createSocialPostUseCase = createSocialPostUseCase;
    }
...
exports.SocialListener = SocialListener = __decorate([
    ...
    __metadata("design:paramtypes", [create_social_post_use_case_1.CreateSocialPostUseCase])
], SocialListener);
