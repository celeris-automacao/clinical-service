...
let TenantsController = class TenantsController {
    constructor(createTenantUseCase, getTenantsUseCase, getTenantByIdUseCase) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Criar uma nova clínica (Tenant)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Clínica e Boss inicial criados com sucesso.' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar todas as clínicas cadastradas' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Buscar detalhes de uma clínica específica' }),
