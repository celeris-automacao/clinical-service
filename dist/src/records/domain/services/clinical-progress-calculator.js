...
exports.ClinicalProgressCalculator = void 0;
const common_1 = require("@nestjs/common");
let ClinicalProgressCalculator = class ClinicalProgressCalculator {
    calculateDamageFromLatestRecords(records) {
        if (records.length < 2) {
            return 0;
        }
        ...
        const muscleDiff = currentMuscle != null && previousMuscle != null ? currentMuscle - previousMuscle : 0;
...
exports.ClinicalProgressCalculator = ClinicalProgressCalculator;
exports.ClinicalProgressCalculator = ClinicalProgressCalculator = __decorate([
    (0, common_1.Injectable)()
], ClinicalProgressCalculator);
//# sourceMappingURL=clinical-progress-calculator.js.map